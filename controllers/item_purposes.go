...
type Item_purposesController struct {
	beego.Controller
}

// URLMapping ...
func (c *Item_purposesController) URLMapping() {
	...
	c.Mapping("GetItemPurposesByItem", c.GetItemPurposesByItem)
}
...
// @Success 200 {object} models.Item_purposes
// @Failure 403 :id is empty
// @router /:id [get]
func (c *Item_purposesController) GetOne() {
...
// GetItemPurposesByItem ...
// @Title Get Item Purposes By Item
// @Description get Item_purposes by Item id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.ItemPurposesResponseDTO
// @Failure 403 :id is empty
// @router /purposes/item/:id [get]
func (c *Item_purposesController) GetItemPurposesByItem() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
...
// @Failure 403
// @router / [get]
func (c *Item_purposesController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
...
// @router /:id [put]
func (c *Item_purposesController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	v := models.Item_purposes{ItemPurposeId: id}
	json.Unmarshal(c.Ctx.Input.RequestBody, &v)
	if err := models.UpdateItem_purposesById(&v); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *Item_purposesController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
	if err := models.DeleteItem_purposes(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
